            ...
            if trades:
                ...
                with t2:
                    ...
                    with cl:
                        ...
                        with st.expander("🔍 Characteristics"): draw_stat("Total Trades", len(df_trades)); draw_stat("Profit Trades", len(wins)); draw_stat("Loss Trades", len(losses)); draw_stat("Winning Streak", max_w_s); draw_stat("Losing Streak", max_l_s)
